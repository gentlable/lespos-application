package jp.co.fullhouse.lespos.lesposapplication.utils;
...
public class GoogleApiUtils {
  ...
  static {
    try {
      FLOW = new GoogleAuthorizationCodeFlow.Builder(Utils.getDefaultTransport(), Utils.getDefaultJsonFactory(),
          loadClientSecrets(), OAUTH_SCOPES)
  ...
  private static GoogleClientSecrets loadClientSecrets() throws IOException {
    ...
    GoogleClientSecrets clientSecrets = GoogleClientSecrets
        .load(Utils.getDefaultJsonFactory(), new InputStreamReader(in, "utf-8"));
